...
import com.justone.data.ble.AdvertiseGameData
import com.justone.data.ble.BLEManager
import com.justone.data.ble.GameState
import java.lang.Integer.max
import javax.inject.Inject
import kotlinx.serialization.decodeFromString
import kotlinx.serialization.json.Json

class JustOneOnlineAdapter @Inject constructor(private val bleManager: BLEManager) {
